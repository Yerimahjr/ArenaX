...
/**
 * Platform-wide event analytics — extracted out of `app/[locale]/analytics/page.tsx`
 * so `recharts` code-splits into its own chunk (#1086) instead of shipping in
 * the initial JS payload for every visitor to the analytics route.
 */
